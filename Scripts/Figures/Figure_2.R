...
ee = mdaplot(po_obrobce_pqn_v2_Rcpm, type = "l", xlab="", main = "PQN",cgroup=cl1,lab.col = "black",
             lab.cex=1.1,yticks = c(20),yticklabels = c("Y"),
             xticks = c(20),xticklabels = c("A"))
axis(1,cex.axis=1.1)
#mtext(Xl,side=1, line=2.4, cex=1.2)
...
#   PQN SG
#
yl=substitute(paste(bold('Absorbance derivative')))
ww=bquote ('wavelength [nm]')
xl=substitute(paste(bold('Wavelength [nm]')))
attr(po_obrobce_smoothed_der, "xaxis.values") = labels
ee = mdaplot(po_obrobce_smoothed_der, type = "l", xlab="", main = "PQN derivative",cgroup=cl1,lab.col = "black",
             lab.cex=1.1,yticks = c(20),yticklabels = c("Y"),
             xticks = c(20),xticklabels = c("A"))
axis(1,cex.axis=1.1)
#mtext(Xl,side=1, line=2.4, cex=1.2)
